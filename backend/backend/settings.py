...
STATICFILES_DIRS = [
    BASE_DIR.parent / 'frontend',  # Remontez d'un niveau pour accéder au dossier 'frontend'.
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'test_transcendance_db',  # Nom de la base de données
        'USER': 'test_user',              # Nom d'utilisateur
